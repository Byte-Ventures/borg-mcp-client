...
import { BORG_LAUNCH_EXPECTED_SEAT_ENV, codexLaunchSeatExpectationConfigArgs, findProjectRoot, getActiveCube, inboxPathForDrone, LaunchSeatIdentityChangedError, } from './cubes.js';
...
import { configureSelectedLaunchCli, discoverLiveLaunchMenuCandidates, isMainGitWorktree, isTerminalLaunchMenuSeatStatus, runBareLaunchMenu, shouldShowLaunchMenu, terminalLaunchMenuSeatNotice, } from './bare-launch-menu.js';
...
async function main() {
    ...
    const subcommandHelp = clientSubcommandHelpText(process.argv[2], process.argv.slice(3), getPackageVersion());
