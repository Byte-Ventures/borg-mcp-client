...
function random256BitIdentity() {
    return randomBytes(32).toString('base64url');
}
export function createOpenCodeLaunchTrust(overrides = {}) {
    const trust = {
...
export function isOpenCode256BitIdentity(value) {
...
export function openCodeApiPasswordFromEnv(env) {
    if (env[OPENCODE_SERVER_USERNAME_ENV] !== OPENCODE_SERVER_USERNAME)
        return null;
