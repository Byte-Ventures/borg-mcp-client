...
export function formatWorkingRepoLabel(drone) {
    ...
    if (drone.working_repo_name)
        return `Working repo: ${drone.working_repo_name}`;
    if (drone.working_repo_origin)
