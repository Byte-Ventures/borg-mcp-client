...
export class InvitationArtifactLegacyError extends Error {
    constructor() {
        super('This invitation uses an older format. Ask the server operator to run `borg server cert-reissue --host <address>` on an updated Borg server, then request a new invitation and retry.');
