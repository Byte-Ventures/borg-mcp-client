...
export declare const KNOWN_SUBCOMMANDS: readonly ["setup", "update", "doctor", "assimilate", "reset-local-connection", "recover-enrollment", "spawn", "cleanup", "drones", "launch", "launch-all", "server"];
/**
