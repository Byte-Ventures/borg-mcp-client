...
export declare const KNOWN_SUBCOMMANDS: readonly ["setup", "update", "assimilate", "clone", "reset-local-seat", "recover-enrollment", "spawn", "sync", "cleanup", "launch-all", "server"];
/**
