...
export declare const KNOWN_SUBCOMMANDS: readonly ["setup", "update", "assimilate", "reset-local-connection", "recover-enrollment", "spawn", "sync", "cleanup", "launch-all", "server"];
/**
