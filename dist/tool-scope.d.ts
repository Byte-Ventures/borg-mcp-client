...
export declare const UNIVERSAL_TOOLS: readonly ["borg_regen", "borg_log", "borg_read-log", "borg_roster", "borg_stream-status", "borg_whoami", "borg_ack", "borg_ack-status", "borg_version", "borg_cube", "borg_role", "borg_role-rationale", "borg_assimilate", "borg_playbook", "borg_docs", "borg_tool", "borg_describe-tool"];
