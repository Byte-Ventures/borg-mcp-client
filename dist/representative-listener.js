...
import { streamOnce, streamReconnectDelay, StreamCursorExpiredError } from './log-stream.js';
    ...
    try {
        ...
        while (!reason) {
            ...
            try {
                ...
                if (!(error instanceof StreamCursorExpiredError) && codeOf(error) !== 'LISTENER_ERROR')
                    throw error;
