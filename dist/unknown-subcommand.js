 ...
 */
export function unknownSubcommand(argv2) {
    if (argv2 === undefined)
        return null; // bare `borg`
    if (argv2.startsWith('-'))
        return null; // a flag → handled downstream
    if (KNOWN_SUBCOMMANDS.includes(argv2))
        return null;
    return argv2; // unknown non-flag positional → footgun
}
//# sourceMappingURL=unknown-subcommand.js.map