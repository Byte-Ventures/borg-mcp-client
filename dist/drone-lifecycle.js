...
export class DroneFrozenError extends Error {
    constructor(message = 'This drone is paused — its cube or seat was frozen by a subscription downgrade. It resumes automatically when billing is restored.') {
        super(message);
 ...
 */
export function formatFrozenToolResult(detail) {
    return (`${FROZEN_RESULT_MARKER} ${detail ?? 'This drone is paused — its cube or seat was frozen by a subscription downgrade.'}\n\n` +
...
//# sourceMappingURL=drone-lifecycle.js.map