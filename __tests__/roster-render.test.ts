...
_Agent CLI and reported model are advisory; they do not determine authority, role, health, activity, wake behavior, or routing. Working repository is the drone's home assignment for implementation work: route repository-specific implementation work to the drone homed in that repository, and drones do not take implementation work outside their home repository. These fields carry no server-side authority, and the server does not enforce repository homing._
